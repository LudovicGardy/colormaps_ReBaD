...
def show_all_available_colormaps(
    HaReBaD_color_matrix_upper: np.ndarray, all_colormaps: object
):
    ...
    ax.set_ylabel(
        f"Color map <i> length (size = {HaReBaD_color_matrix_upper.shape[0]})"
    )
